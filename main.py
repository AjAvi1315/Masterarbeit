...
if __name__ == '__main__':
    ...
    y = np.array([[-0.586, -0.57705, -0.56835, -0.47205, -0.1697, 0.48395, 0.7855, 0.9385, 1.0275, 1.0965, 1.1605, 1.228, 1.293,
         1.353, 1.538, 1.523]])
    ...
    time_steps = 12
    t = np.array(range(0, time_steps * 4 + 2))  # jährliche Timesteps || +2 für bessere Schleifen duchläufe um auf exat 15 zu kommen
    t = t / time_steps
    t_len = len(t)
    ...
    swap_option = SwapOption(sigma, t, t_E, tenor, c, option_type, a, forward_rates)
